...
class WristbandApp:
    ...
    def show_profile(self):
        ...
        if user_data:
            ...
            ttk.Button(profile_frame, text="Back", bootstyle="secondary", command=self.show_features_frame).pack(pady=20)
    ...
    def show_add_device(self):
        ...
        ttk.Button(self.add_device_window, text="Save", bootstyle="success", command=self.save_device_mode).pack(pady=10)
